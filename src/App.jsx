...
function App() {
  ...
  useEffect(() => {
    if (isGalleryActive) {
      // Salviamo la posizione attuale prima di bloccare
                ...
                <div className="w-full h-full flex items-center justify-center relative bg-transparent">
                  {!isGalleryActive ? (
                    <div className="w-full h-full relative flex items-center justify-center">
                      ...
                      <DomeGallery fit={1.2} segments={25} grayscale={true} minRadius={600} />
                    </div>
                  ) : showContent ? (
                    <div className="w-full h-full animate-in fade-in duration-1000"><DomeGallery fit={0.9} segments={25} grayscale={false} maxVerticalRotationDeg={600}  minRadius={!isGalleryActive ? 500 : 550} /></div>
                  ) : (
